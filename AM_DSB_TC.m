...
figure(1); %cria uma janela de figura
...
figure(2); %cria uma janela de figura
...
% *Plot do Modulo do Espectro de Frequencia da Mensagem M(f)*
figure(3); %cria uma janela de figura
...
% *Plot do Modulo do Espectro de Frequencia da Portadora C(f)|*
subplot(3,1,2); %divide a janela de figura em 3x1 e seleciona a segunda parte para o plot atual
...
% *Plot do Modulo do Espectro de Frequequencia do Sinal Modulado S(f)*
subplot(3,1,3); %divide a janela de figura em 3x1 e seleciona a terceira parte para o plot atual
...
% Na figura 4 e possivel ver o sinal de saida do filtro vo(t), com amplitude sendo metade do sinal da mensagem m(t)
...
figure(4); %cria uma janela de figura
...
figure(5); %cria uma janela de figura
...
% *Plot do Modulo do Espectro de Frequequencia do Sinal V(f)*
...
% *Plot do Modulo do Espectro de Frequequencia do Filtro H(f)*
...
% *Plot do Modulo do Espectro de Frequequencia do Sinal Recuperado |Vo(f)|*
